...
I co-founded [BidChex](https://bidchex.com) and I run engineering there. It is a platform homeowners associations use to manage capital projects and take bids from vendors. In practice that means a NestJS backend on PostgreSQL, an Angular web app, a mobile client, and a SOAP bridge into QuickBooks, because that is the accounting software the people on the other end already have open.

The piece I spend the most time on is the extraction layer. Bid documents arrive as whatever the vendor felt like sending, and the job is to get them into rows you can put next to each other.
...
daily:    TypeScript · NestJS · Angular · PostgreSQL · AWS
lately:   document extraction, MCP servers, agent tooling
...
The numbers come from WakaTime and the GitHub GraphQL API, and a scheduled Action redraws them every six hours. I render the SVGs myself in [`src/cards`](src/cards) instead of pointing at one of the usual badge services. Those get rate limited, and when they do your profile sits there showing a broken image until somebody notices. Dark and light versions are both committed and swapped with `prefers-color-scheme`.
...
<sub><b>1,696 hrs 44 mins</b> of tracked coding since Sun Jan 11th 2026 · currently averaging <b>8 hrs 52 mins</b> per day · <b>TypeScript</b> is 24% of this week</sub>
...
<div align="center"><sub>Read from the GitHub API at build time, so this follows whatever I have pinned.</sub></div>
...
<sub>Last rebuild: <b>8 Sept 2026, 13:00 (BRT)</b> · 4,394 contributions in the last 12 months</sub>
