...
I design and ship **production systems**, not demos. Today that means **[BidChex](https://bidchex.com)**, which I co-founded and where I run engineering: a platform where homeowners associations manage their capital projects and vendor bidding end to end. On the engineering side that is a NestJS + PostgreSQL backend, an Angular front end, a mobile client, a QuickBooks Web Connector (SOAP) integration for accounting, and an AI layer that turns messy project documents into structured, comparable data.
...
craft:     Senior Web Software Architect · AI Engineer
...
<sub><b>1,696 hrs 37 mins</b> of tracked coding since Sun Jan 11th 2026 · currently averaging <b>8 hrs 52 mins</b> per day · <b>TypeScript</b> is 24% of this week</sub>
